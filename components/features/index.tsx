export default function Features() {
  return (
    <div className="relative bg-white flex justify-center mx-8 my-7 font-poppins flex-col items-center h-full">
        <div className="bg-white mt-24 mb-8 px-4 py-2 relative text-slate-blue rounded-full flex flex-row justify-between gap-2 items-center border-3 border-[#FAFCFE]">
